...
const iphoneSteps: WorkflowStep[] = [
  {
    ...
    screen: {
      ...
      rows: [
        { label: "About" },
        { label: "Software Update", highlight: true },
        { label: "AirDrop" },
        { label: "Storage" },
      ],
    },
    ...
    why: updateWhy,
    whatNext:
      "After the update finishes, you will check the software version. If IT asked for a reset, that comes after.",
  ...
  },
  {
    ...
    screen: {
      ...
      rows: [
        ...
        { label: "iOS version", value: "See IT instructions", highlight: true },
        { label: "Your iPhone is up to date" },
      ],
    },
    lookFor: "The software version shown on your iPhone",
    why: {
      title: "Why check the version?",
      body: "The app cannot see your iPhone. Only you can confirm the update finished. Checking the version makes sure the next steps will work.",
    },
  ...
  },
  {
    ...
    screen: {
      ...
      rows: [
        { label: "Prepare for New iPhone" },
        { label: "Reset" },
        { label: "Erase All Content and Settings", highlight: true },
      ],
    },
    ...
    troubleshoot: {
      noButton:
        "Make sure you are in Settings → General, then scroll all the way down. If you still don't see it, contact Field Support.",
    },
  },
  {
    id: "confirm-reset",
    ...
    screen: {
      ...
      body: "All content and settings will be removed.",
      button: "Erase iPhone",
      highlight: true,
    },
    ...
    troubleshoot: {
      error:
        "If you see a message about an account or passcode you don't recognize, stop here. Do not guess. Contact Field Support.",
    },
  },
  {
    id: "hello",
    ...
    todo: [
      ...
      "Wait for the Hello screen.",
      "Swipe up or press Home to begin.",
    ],
    ...
    troubleshoot: {
      stuck:
        "A dark screen or Apple logo for a few minutes is normal. Keep it plugged in. If nothing changes after 10 minutes, contact Field Support.",
    },
  },
  {
    id: "language",
    ...
    todo: [
      "Tap English (or your language).",
      "Tap United States (or your region).",
      "Tap Continue if asked.",
    ],
    screen: {
      kind: "list",
      title: "Language",
      rows: [{ label: "English", highlight: true }, { label: "Español" }, { label: "Français" }],
    },
    lookFor: "English",
  ...
  },
  {
    ...
    todo: [
      "Tap the Wi-Fi network you were told to use.",
    ...
    screen: {
      ...
      rows: [{ label: "Your Wi-Fi network", highlight: true }, { label: "Other network" }],
    },
    ...
    troubleshoot: {
      error:
        "Double-check the Wi-Fi password. If you're not sure which network to use, contact Field Support.",
    },
  },
  {
    id: "signin",
    ...
    todo: [
      "Enter your Sprinter Health email address.",
      "Tap Next.",
      "Enter your password.",
      "Complete any sign-in prompt you normally use.",
    ],
    screen: {
      kind: "message",
      title: "Sign in",
      body: "Sprinter Health",
      button: "Next",
      highlight: true,
    },
    lookFor: "The Sprinter Health sign-in page",
    why: {
      title: "Why do I sign in here?",
      body: "Signing in tells the new system this is your Sprinter Health iPhone so it can set things up for you.",
    },
  ...
  },
  {
    ...
    todo: [
      ...
      "Do not restart it unless instructed.",
      "Wait until the screen moves on by itself.",
    ],
    screen: {
      kind: "wait",
      title: "Configuring your iPhone…",
      body: "Sprinter Health is setting up your device.",
    },
    why: configWhy,
    whatNext:
      "When it finishes, the iPhone will ask you to finish a few setup items like a passcode.",
    nextLabel: "It finished, continue setup",
    troubleshoot: {
      stuck:
        "This step really can take several minutes. Keep the device plugged in. If it hasn't moved after 20 minutes, contact Field Support.",
    },
  },
  {
    id: "setup",
    ...
    todo: [
      "Create a passcode if asked.",
      "Set up Face ID if asked.",
      "Set up your authenticator app if asked.",
    ...
    screen: {
      ...
      rows: [
        ...
        { label: "Face ID" },
        { label: "Authenticator" },
        { label: "Apps installing…", highlight: true },
      ],
    },
  ...
  },
  {
    ...
    intro:
      "The app was removed when your iPhone was erased. This is expected. Use your original TestFlight invitation email to install it again.",
    todo: [
    ...
    screen: {
      kind: "message",
      title: "Sprinter Health Invitation",
      body: "Open this email on your iPhone.",
      button: "View in TestFlight",
      highlight: true,
    },
  ...
  },
  {
    ...
    todo: [
      ...
      "Make sure the Sprinter Health apps are there.",
      "Open one app to make sure it starts.",
    ],
    screen: {
      kind: "home",
      title: "Home",
      apps: ["Sprinter", "Mail", "Slack", "Authenticator", "Settings", "Phone"],
    },
...
const ipadMiniSteps: WorkflowStep[] = [
  ...
  },
  {
    ...
    screen: {
      ...
      rows: [
        { label: "Automatic Updates", value: "On" },
        { label: "iOS version", value: "See IT instructions", highlight: true },
        { label: "Your iPad Mini is up to date" },
      ],
    },
    lookFor: "The software version shown on your iPad Mini",
    why: {
      title: "Why check the version?",
      body: "The app cannot see your iPad Mini. Only you can confirm the update finished. Checking the version makes sure the next steps will work.",
    },
    nextLabel: "Version confirmed, continue",
  },
  {
    ...
    screen: {
      kind: "list",
      title: "Transfer or Reset iPad",
      rows: [
        { label: "Prepare for New iPad" },
        { label: "Reset" },
        { label: "Erase All Content and Settings", highlight: true },
      ],
    },
  ...
  },
  {
    ...
    todo: [
      "Tap Continue.",
      "Enter the iPad passcode if asked.",
      "Tap Erase iPad.",
      "Wait, the iPad restarts on its own.",
    ],
    screen: {
      kind: "message",
      title: "Erase This iPad",
      body: "All content and settings will be removed.",
      button: "Erase iPad",
      highlight: true,
    },
  ...
  },
  {
    ...
    screen: {
      kind: "list",
      title: "Language",
      rows: [{ label: "English", highlight: true }, { label: "Español" }],
    },
    lookFor: "English",
    nextLabel: "Connect to Wi-Fi",
  },
  ...
  },
  {
    ...
    intro: "Use the Sprinter Health account IT gave you.",
    todo: [
      "Enter your Sprinter Health email.",
      "Tap Next.",
      "Enter your password.",
      "Complete any sign-in prompt you normally use.",
    ],
    ...
    troubleshoot: {
      error:
        "This means the iPad could not complete the sign-in step. Do not keep trying random options. Contact Field Support.",
    },
  },
  {
    id: "configure",
  ...
  },
  {
    ...
    todo: [
      "Create a passcode if asked.",
      "Set up Touch ID or Face ID if asked.",
      "Wait for apps to install.",
    ],
    screen: {
      kind: "list",
  ...
  },
  {
    ...
    title: "Reinstall Sprinter Health with TestFlight",
    intro:
      "The app was removed when your iPad Mini was erased. This is expected. Use your original TestFlight invitation email to install it again.",
    todo: [
    ...
    screen: {
      kind: "message",
      title: "Sprinter Health Invitation",
      body: "Open this email on your iPad Mini.",
      button: "View in TestFlight",
      highlight: true,
    },
    lookFor: "View in TestFlight in your original invitation email",
  ...
  },
  {
    ...
    screen: {
      kind: "home",
      title: "Home",
      apps: ["Sprinter", "Mail", "Slack", "Settings", "Safari", "Photos"],
    },
    lookFor: "Your Sprinter Health apps",
    nextLabel: "Finish",
  },
...
const patientIpadSteps: WorkflowStep[] = [
  ...
  },
  {
    ...
    screen: {
      ...
      rows: [
        { label: "Automatic Updates", value: "On" },
        { label: "iOS version", value: "See IT instructions", highlight: true },
        { label: "Your iPad is up to date" },
      ],
    },
    lookFor: "The software version shown on your iPad",
    why: {
      title: "Why check the version?",
      body: "The app cannot see your iPad. Only you can confirm the update finished. Checking the version makes sure the next steps will work.",
    },
    nextLabel: "Version confirmed, continue",
  },
  {
  ...
  },
  {
    ...
    todo: [
      "Enter the Sprinter Health email for this iPad.",
      "Tap Next.",
      "Enter the password.",
      "Complete any sign-in prompt shown.",
    ],
    screen: {
      kind: "message",
      title: "Sign in",
  ...
  },
  {
    ...
    todo: [
      "If asked, sign in again with the same Sprinter Health account.",
      "Complete any sign-in prompt shown.",
      "If nothing is asked, just continue.",
    ],
    screen: {
      kind: "message",
  ...
  },
  {
    ...
    title: "Reinstall Sprinter Health with TestFlight",
    intro:
      "The app was removed when the Patient-Facing iPad was erased. This is expected. Use the original TestFlight invitation email to install it again.",
    todo: [
    ...
    screen: {
      kind: "message",
      title: "Sprinter Health Invitation",
      body: "Open this email on the Patient-Facing iPad.",
      button: "View in TestFlight",
      highlight: true,
    },
  ...
  },
  {
    ...
    todo: [
      "Look at the home screen.",
      "Make sure the Sprinter Health patient apps are there.",
      "Open one app to make sure it starts.",
    ],
    screen: {
      kind: "home",
      title: "Home",
      apps: ["Sprinter Health", "Settings", "Safari", "Camera"],
    },
